...
def generate_launch_description():
    ...
    rviz2_node = Node(
        package="rviz2",
        executable="rviz2",
        # arguments=['-d', os.path.join(get_package_share_directory(package_name), 'rviz', 'IMU2.rviz')]
    )
    # print('-d ' +os.path.join(get_package_share_directory(package_name), 'rviz', 'LO.rviz'))
